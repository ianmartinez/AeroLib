' A standalone file for dealing with Aero
...
#End Region
    ...
    Public Sub Extend(ByVal Window As Form, ByVal Left As Integer, ByVal Right As Integer, ByVal Top As Integer, ByVal Bottom As Integer)
        If DWMEnabled() Then
    ...
    Public Sub Retract(ByVal Window As Form)
        If DWMEnabled() Then
            Window.BackColor = SystemColors.Control
            Dim AeroMargins As New Margins
    ...
    Public Sub SurroundControl(ByVal Window As Form, ByVal Control As Control)
        If DWMEnabled() Then
            Aero.Extend(Window, Control.Left, Window.ClientSize.Width - Control.Right, Control.Top, Window.ClientSize.Height - Control.Bottom)
        End If
    End Sub
